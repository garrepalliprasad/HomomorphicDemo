    ...
    partial class Program
    {
      ...
      EncryptionParameters parms = context.FirstContextData.Parms;
            ...
            Func<RelinKeys> GetRelinKeys = () => {
                if (context.UsingKeyswitching)
                {
                    ...
                    */
                    ...
                    keygen.CreateRelinKeys(out RelinKeys relnKeys);
            ...
            Func<GaloisKeys> GetGaloisKeys = () => {
             ...
             RelinKeys relinKeys = GetRelinKeys();
             GaloisKeys galKeys = GetGaloisKeys();
            ...
            */
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                */
                 Plaintext plain1 = new Plaintext(parms.PolyModulusDegree, 0);
